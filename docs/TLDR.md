...
**Where it is, 2026-09-25.** **`v0.1.6` is prepared and not cut** (`release/0.1.6-prep`, 2591 off-game checks):
...
and was checked against 1.0.16 by the engine sweep and an offline probe run (`ENGINE-BASELINE.md`).
