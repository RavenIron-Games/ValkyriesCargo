...
| Source art in the repo | `models/ingvar.fbx` + `models/ingvar_albedo.png` (11 MB) are the one named exception to "no binaries" (WORKSPLIT §4, PR #4); the bundle still ships in the package, Meshy's raw output stays out | locked (Wu'barrk decided, Nomad agreed 2026-09-06) |
